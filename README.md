...
- **Инициализация:** Использовались предзагруженные веса (Pre-trained weights) для конфигурации **YOLOX-L**.
    
- **Результат:** Модель демонстрирует высокую скорость работы и точность обнаружения объектов даже в условиях плотной городской застройки.
...
👉 **[Ноутбуки с экспериментами и обучением](https://github.com/shalfei/satellite_images_building_area/blob/main/INSTALL.md)**
